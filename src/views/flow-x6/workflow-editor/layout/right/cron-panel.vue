<template>
  <div class="el-workflow-editor-cron-panel">
    <el-form
      ...
      @submit.prevent
    >
      <el-form-item label="schedule" prop="schedule" class="schedule-item">
        <el-input v-model="form.schedule" placeholder="请输入cron表达式"></el-input>
      </el-form-item>
