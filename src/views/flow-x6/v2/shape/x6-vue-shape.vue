<template>
  <div ref="shape" :class="{ 'jm-workflow-x6-vue-shape': true, clickable }" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
    <div class="icon">
<!--      <img class="img" :src="iconUrl">-->
      <div class="img" :style="`background-image: url('${iconUrl}');`"></div>
    </div>
    <span class="jm-text-viewer">{{nameVal}}</span>
  </div>
</template>
