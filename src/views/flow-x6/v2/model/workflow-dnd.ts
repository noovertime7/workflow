...
import {register} from "../shape/custom-vue-shape";
...
export const getImageUrl = (name:string) => new URL(`../svgs/shape/${name}`, import.meta.url).href